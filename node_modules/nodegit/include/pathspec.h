...
class GitPathspec : public ObjectWrap {
  ...
  private:
    ...
    class MatchDiffWorker : public NanAsyncWorker {
      public:
        MatchDiffWorker(
    ...
    class MatchIndexWorker : public NanAsyncWorker {
      public:
        MatchIndexWorker(
    ...
    class MatchTreeWorker : public NanAsyncWorker {
      public:
        MatchTreeWorker(
    ...
    class MatchWorkdirWorker : public NanAsyncWorker {
      public:
        MatchWorkdirWorker(
