...
class GitMerge : public ObjectWrap {
  public:
  ...
  private:
    ...
    class BaseWorker : public NanAsyncWorker {
      public:
        BaseWorker(
            BaseBaton *_baton,
    ...
    class BasesWorker : public NanAsyncWorker {
      public:
        BasesWorker(
            BasesBaton *_baton,
            NanCallback *callback
    ...
    class CommitsWorker : public NanAsyncWorker {
      public:
        CommitsWorker(
            CommitsBaton *_baton,
            NanCallback *callback
    ...
    class TreesWorker : public NanAsyncWorker {
      public:
        TreesWorker(
            TreesBaton *_baton,
            NanCallback *callback
