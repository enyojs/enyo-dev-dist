...
class GitIndex : public ObjectWrap {
  ...
  private:
    ...
    class AddAllWorker : public NanAsyncWorker {
      public:
        AddAllWorker(
            AddAllBaton *_baton,
    ...
    class ConflictGetWorker : public NanAsyncWorker {
      public:
        ConflictGetWorker(
    ...
    class RemoveAllWorker : public NanAsyncWorker {
      public:
        RemoveAllWorker(
    ...
    class UpdateAllWorker : public NanAsyncWorker {
      public:
        UpdateAllWorker(
    ...
    class WriteTreeToWorker : public NanAsyncWorker {
      public:
        WriteTreeToWorker(
