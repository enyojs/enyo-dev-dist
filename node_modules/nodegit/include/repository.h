...
class GitRepository : public ObjectWrap {
  ...
  private:
    ...
    class ConfigWorker : public NanAsyncWorker {
      public:
        ConfigWorker(
            ConfigBaton *_baton,
    ...
    class ConfigSnapshotWorker : public NanAsyncWorker {
      public:
    ...
    class FetchheadForeachWorker : public NanAsyncWorker {
      public:
    ...
    class OdbWorker : public NanAsyncWorker {
      public:
        OdbWorker(
            OdbBaton *_baton,
            NanCallback *callback
    ...
    class OpenBareWorker : public NanAsyncWorker {
      public:
        OpenBareWorker(
    ...
    class OpenExtWorker : public NanAsyncWorker {
      public:
        OpenExtWorker(
            OpenExtBaton *_baton,
            NanCallback *callback
    ...
    class RefdbWorker : public NanAsyncWorker {
      public:
        RefdbWorker(
            RefdbBaton *_baton,
            NanCallback *callback
    ...
    class SetHeadWorker : public NanAsyncWorker {
      public:
        SetHeadWorker(
            SetHeadBaton *_baton,
            NanCallback *callback
    ...
    class WrapOdbWorker : public NanAsyncWorker {
      public:
        WrapOdbWorker(
            WrapOdbBaton *_baton,
            NanCallback *callback
